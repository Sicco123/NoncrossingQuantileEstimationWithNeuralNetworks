...
class l1_p(layers.Layer): #This class builds on the layer class of keras.
    """
    The l1_p layer is a layer built on the layer class of keras. It introduces a way
    of penalizing the distance between quantiles such that they are noncrossing.
    The l1 penalization layer follow the idea in "Learning Multiple Quantile With Neural Networks"
    of Moon et all.
    """

    def __init__(self, number_of_quantiles, penalty_1, penalty_2, **kwargs):
...
def non_cross_transformation(predicted_y, delta_coef_matrix, delta_0_matrix):
    """
    This function is used to enforce noncrossing quantiles. In case of no Convergence.
    """
